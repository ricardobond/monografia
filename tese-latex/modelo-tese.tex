...
\autor{Ricardo Figueiredo Caldeira} % (José da Silva)
\autorR{Caldeira, Ricardo Figueiredo} % (da Silva, José)

\titulo{A adoção do MVP como ferramenta de validação de hipóteses de mercado para startups enxutas}
...
\ano{2013} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}

%-------------------------------------------------------------- ORIENTADOR %
\orientador{Marcos Inácio Severo de Almeida}
\orientadorR{Almeida, Marcos Inácio Severo de}
...
\coorientadorR{Oliveira, Leandro Luís Galdino de}
