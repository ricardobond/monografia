...
\autor{\textless Ricardo Figueiredo Caldeira\textgreater} % (José da Silva)
\autorR{\textless Caldeira, Ricardo Figueiredo\textgreater} % (da Silva, José)

\titulo{\textless Título do Trabalho\textgreater}
\subtitulo{\textless Subtítulo do Trabalho\textgreater}

\cidade{\textless Goiânia\textgreater} % Nome da cidade em foi desenvolvido o trabalho
\dia{\textless 01\textgreater} %
\mes{\textless 08\textgreater} % Data da apresentação/defesa do trabalho
\ano{\textless 2013\textgreater} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}

%-------------------------------------------------------------- ORIENTADOR %
\orientador{\textless Marcos Inácio Severo de Almeida\textgreater}
\orientadorR{\textless Almeida, Marcos Inácio Severo de\textgreater}
...
\coorientador{\textless Leandro Luís Galdino de Oliveira\textgreater}
\coorientadorR{\textless Oliveira, Leandro Luís Galdino de\textgreater}
...
\universidade{\textless Universidade Federal de Goiás\textgreater} % {Universidade Federal de Goiás}
\uni{\textless UFG\textgreater}         % UFG
\unidade{\textless Instituto de Informática\textgreater} %Instituto de Informática
...
\concentracao{\textless Sistemas de Informação\textgreater}
...
\bibliography{./bib/modelo-tese}
\arial
%\bibsliography{./bib/modelo-tese} %%% Nomes dos seus arquivos .bib
