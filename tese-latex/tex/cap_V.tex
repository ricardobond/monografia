...
Futuramente planeja--se para a \emph{gem} Perpetuus suporte a outros \emph{frameworks} de desenvolvimento \emph{web}, como o \emph{Sinatra} e o \emph{Java Server Faces} dado que o cerne do \emph{plugin} pode gerar \emph{templates} para diferentes linguagens de programação.

Pesquisas futuras podem verificar se a ferramenta desenvolvida de fato acelera a construção de MVP's 